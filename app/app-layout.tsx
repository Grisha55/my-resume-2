...
console.log("%c🛠️ ТЕХНИЧЕСКИЕ НАВЫКИ %c\n", "color: #fff; background: #ff6b6b; font-size: 16px; font-weight: bold; padding: 4px 8px; border-radius: 4px;", "color: #fff;");
...
const experience = [
    { period: "2022–н.в.", company: "TechCorp", position: "Lead Frontend Developer" },
    { period: "2019–2022", company: "StartupX", position: "Full-Stack Developer" },
